    ...
    if (__argc == 3) {
        ...
        if (ARG1 == "OPEN") {
            if (ARG2 == "PFXSTUDIO") {
                ...
                Code += "SameWidth=\"" + GetProcessName() + "+" + GetAddress(cVideo.bSameWidth) + "\"\n";
                ...
                Code += "VisualizePitchBends=\"" + GetProcessName() + "+" + GetAddress(cVideo.bVisualizePitchBends) + "\"\n";
                Code += "PhigrosMode=\"" + GetProcessName() + "+" + GetAddress(cControls.bPhigros) + "\"\n";
                Code += "ShowMarkers=\"" + GetProcessName() + "+" + GetAddress(cVideo.bShowMarkers) + "\"\n";
                Code += "TickBased=\"" + GetProcessName() + "+" + GetAddress(cVideo.bTickBased) + "\"\n";
                Code += "HideStatistics=\"" + GetProcessName() + "+" + GetAddress(cVideo.bDisableUI) + "\"\n";
                ...
                Code += "end\n";
                Code += "function WaitUntilTime(TargetTime)\n";
                Code += "while (GetMicroseconds()<TargetTime and GetTicks()<TotalTicks) do end\n";
                Code += "end\n";
                Code += "function WaitUntilTick(TargetTime)\n";
                Code += "while (GetTicks()<TargetTime and GetTicks()<TotalTicks) do end\n";
                Code += "end\n";
                ...
                Code += "while (GetMicroseconds()<=EndTime and GetTicks()<TotalTicks) do\n";
                Code += "SetValueFunction(StartValue+EasingFunction((GetMicroseconds()-StartTime)/(EndTime-StartTime))*(EndValue-StartValue))\n";
                Code += "while (GetMicroseconds()<StartTime+Spacing*SliceIndex and GetTicks()<TotalTicks) do end\n";
                ...
                Code += "createThread(function()\n";
                Code += "while (GetMicroseconds()<Time and GetTicks()<TotalTicks) do end\n";
                ...
                Code += "while (GetTicks()<=EndTime and GetTicks()<TotalTicks) do\n";
                Code += "SetValueFunction(StartValue+EasingFunction((GetTicks()-StartTime)/(EndTime-StartTime))*(EndValue-StartValue))\n";
                Code += "while (GetTicks()<StartTime+Spacing*SliceIndex and GetTicks()<TotalTicks) do end\n";
                Code += "SliceIndex=SliceIndex+1\n";
                Code += "end\n";
                Code += "SetValueFunction(EndValue)\n";
                Code += "end).resume()\n";
                ...
                Code += "createThread(function()\n";
                Code += "while (GetTicks()<Time and GetTicks()<TotalTicks) do end\n";
                Code += "SetValueFunction(Value)\n";
                Code += "end).resume()\n";
                Code += "end\n";
                Code += "function SmoothAnimationByTimeAndWait(StartValue,EndValue,StartTime,EndTime,EasingFunction,SetValueFunction)\n";
                Code += "while (GetMicroseconds()<StartTime and GetTicks()<TotalTicks) do end\n";
                Code += "while (GetMicroseconds()<=EndTime and GetTicks()<TotalTicks) do\n";
                Code += "SetValueFunction(StartValue+EasingFunction((GetMicroseconds()-StartTime)/(EndTime-StartTime))*(EndValue-StartValue))\n";
                Code += "end\n";
                Code += "SetValueFunction(EndValue)\n";
                Code += "end\n";
                Code += "function TargetAnimationByTimeAndWait(GetValueFunction,TargetValue,StartTime,EndTime,EasingFunction,SetValueFunction)\n";
                Code += "while (GetMicroseconds()<StartTime and GetTicks()<TotalTicks) do end\n";
                Code += "local StartValue=GetValueFunction()\n";
                Code += "while (GetMicroseconds()<=EndTime and GetTicks()<TotalTicks) do\n";
                Code += "SetValueFunction(StartValue+EasingFunction((GetMicroseconds()-StartTime)/(EndTime-StartTime))*(TargetValue-StartValue))\n";
                ...
                Code += "SetValueFunction(TargetValue)\n";
                Code += "end\n";
                Code += "function SlicedSmoothAnimationByTimeAndWait(StartValue,EndValue,StartTime,EndTime,Spacing,EasingFunction,SetValueFunction)\n";
                Code += "while (GetMicroseconds()<StartTime and GetTicks()<TotalTicks) do end\n";
                Code += "local SliceIndex=1\n";
                Code += "while (GetMicroseconds()<=EndTime and GetTicks()<TotalTicks) do\n";
                Code += "SetValueFunction(StartValue+EasingFunction((GetMicroseconds()-StartTime)/(EndTime-StartTime))*(EndValue-StartValue))\n";
                ...
                Code += "SetValueFunction(EndValue)\n";
                Code += "end\n";
                Code += "function SlicedTargetAnimationByTimeAndWait(GetValueFunction,TargetValue,StartTime,EndTime,Spacing,EasingFunction,SetValueFunction)\n";
                Code += "while (GetMicroseconds()<StartTime and GetTicks()<TotalTicks) do end\n";
                Code += "local StartValue=GetValueFunction()\n";
                Code += "local SliceIndex=1\n";
                Code += "while (GetMicroseconds()<=EndTime and GetTicks()<TotalTicks) do\n";
                ...
                Code += "SetValueFunction(TargetValue)\n";
                Code += "end\n";
                Code += "function InstantaneousAnimationByTimeAndWait(Value,Time,SetValueFunction)\n";
                Code += "while (GetMicroseconds()<Time and GetTicks()<TotalTicks) do end\n";
                Code += "SetValueFunction(Value)\n";
                Code += "end\n";
                Code += "function SmoothAnimationByTickAndWait(StartValue,EndValue,StartTime,EndTime,EasingFunction,SetValueFunction)\n";
                Code += "while (GetTicks()<StartTime and GetTicks()<TotalTicks) do end\n";
                Code += "while (GetTicks()<=EndTime and GetTicks()<TotalTicks) do\n";
                Code += "SetValueFunction(StartValue+EasingFunction((GetTicks()-StartTime)/(EndTime-StartTime))*(EndValue-StartValue))\n";
                Code += "end\n";
                Code += "SetValueFunction(EndValue)\n";
                Code += "end\n";
                Code += "function TargetAnimationByTickAndWait(GetValueFunction,TargetValue,StartTime,EndTime,EasingFunction,SetValueFunction)\n";
                Code += "while (GetTicks()<StartTime and GetTicks()<TotalTicks) do end\n";
                Code += "local StartValue=GetValueFunction()\n";
                Code += "while (GetTicks()<=EndTime and GetTicks()<TotalTicks) do\n";
                Code += "SetValueFunction(StartValue+EasingFunction((GetTicks()-StartTime)/(EndTime-StartTime))*(TargetValue-StartValue))\n";
                ...
                Code += "SetValueFunction(TargetValue)\n";
                Code += "end\n";
                Code += "function SlicedSmoothAnimationByTickAndWait(StartValue,EndValue,StartTime,EndTime,Spacing,EasingFunction,SetValueFunction)\n";
                Code += "while (GetTicks()<StartTime and GetTicks()<TotalTicks) do end\n";
                Code += "local SliceIndex=1\n";
                Code += "while (GetTicks()<=EndTime and GetTicks()<TotalTicks) do\n";
                Code += "SetValueFunction(StartValue+EasingFunction((GetTicks()-StartTime)/(EndTime-StartTime))*(EndValue-StartValue))\n";
                ...
                Code += "SetValueFunction(EndValue)\n";
                Code += "end\n";
                Code += "function SlicedTargetAnimationByTickAndWait(GetValueFunction,TargetValue,StartTime,EndTime,Spacing,EasingFunction,SetValueFunction)\n";
                Code += "while (GetTicks()<StartTime and GetTicks()<TotalTicks) do end\n";
                Code += "local StartValue=GetValueFunction()\n";
                Code += "local SliceIndex=1\n";
                Code += "while (GetTicks()<=EndTime and GetTicks()<TotalTicks) do\n";
                ...
                Code += "SetValueFunction(TargetValue)\n";
                Code += "end\n";
                Code += "function InstantaneousAnimationByTickAndWait(Value,Time,SetValueFunction)\n";
                Code += "while (GetTicks()<Time and GetTicks()<TotalTicks) do end\n";
                Code += "SetValueFunction(Value)\n";
                Code += "end\n";
                ...
                Code += "InstantaneousAnimationByTime(\"\",0,SetCaption)\n";
